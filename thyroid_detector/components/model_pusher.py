...
from thyroid_detector.entity.config_entity import ModelPusherConfig
from thyroid_detector.entity.artifact_entity import DataTransformationArtifact,ModelTrainerArtifact,ModelPusherArtifact
from thyroid_detector.utils import save_object,load_object
import os,sys
...
class ModelPusher:
    ...
    def initiate_model_pusher(self) -> ModelPusherArtifact:
        try:
            #load object
            logging.info("Loading model , transformer and label encoder")
            ...
            label_encoder_path=self.model_resolver.get_latest_save_label_encoder_path()
